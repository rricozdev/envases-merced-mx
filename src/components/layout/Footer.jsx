 ...
 *
 * Responsabilidades:
 * - Mostrar información institucional (logo, descripción)
 * - Proveer datos de contacto
 * - Listar sucursales y enlaces útiles
 *
 * Mejora aplicada:
 * - Eliminado centrado en mobile
 * - Alineación consistente a la izquierda (mejor UX)
 * - Ajustes en spacing y consistencia visual
 */
  ...
  return (
    <footer className="bg-bgligth-footer text-txtdark-brand-primary dark:bg-bgdark-footer dark:text-txtdark-brand-primary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
         ...
         *
         * IMPORTANTE:
         * - Se elimina el centrado en mobile (text-left siempre)
         */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-12 text-left">
           ...
           * CONTACTO
           *
           * Uso de <address> por semántica HTML
           */}
          <address className="flex flex-col items-start space-y-4 not-italic">
            <h3 className="text-lg font-semibold text-white">Contacto</h3>
         ...
         * FOOTER BOTTOM
         *
         * - Texto centrado en mobile (ok aquí)
