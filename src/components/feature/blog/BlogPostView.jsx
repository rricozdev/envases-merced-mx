...
export default function BlogPostView({ post, children }) {
  ...
  return (
    <>
      ...
      <main id="main-content" className="min-h-screen bg-bgligth-main dark:bg-bgdark-main">
              ...
              >
                ...
                >
                  ...
                  <div className="ml-auto flex items-center gap-2">
                    ...
                    >
                      <svg aria-hidden="true" focusable="false" className="size-4" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                      <svg aria-hidden="true" focusable="false" className="size-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
